...
bundle exec jekyll build >/tmp/light-mode-card-hover-shadow-jekyll.log

site_port="${LIGHT_MODE_CARD_TEST_PORT:-4111}"
chrome_port="${LIGHT_MODE_CARD_CHROME_PORT:-9231}"
site_log="/tmp/light-mode-card-hover-shadow-site.log"
chrome_log="/tmp/light-mode-card-hover-shadow-chrome.log"
chrome_tmp="$(mktemp -d)"
...
const expectedCardBoxShadow = "rgba(0, 0, 0, 0.02) 0px 1px 3px 0px, rgba(0, 0, 0, 0.14) 0px 1px 2px 0px";
...
const expectedCardHoverBoxShadow = "rgba(0, 0, 0, 0.08) 0px 4px 12px 0px, rgba(0, 0, 0, 0.08) 0px 2px 4px 0px";
