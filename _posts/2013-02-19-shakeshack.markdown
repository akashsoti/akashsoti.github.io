...
<section class="section-bottom-margin">
	...
	<p>
			The brand is well known in the US, especially in New York, where it first started its journey from a hot dog cart in Madison Square Park. Punchh wanted to help Shake Shack (SS) build its own loyalty system for customers, where SS can reward frequent visits, gain customer insights, and much more.
	</p>
